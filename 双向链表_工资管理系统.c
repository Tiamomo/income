...
Copyright (C语言), 2018, Mango Tech. Co., Ltd.
 文件名: 工资管理.c
 Author:蒙世满(117583010128) Version:C语言&双向链表 Date:5,7,2018 
 Description: 
 I. 主要功能:()
...
/*************************************************
 ...
 Table Accessed: 无
 Table Updated: 无
 Input: 此函数从调用处获取值 "shouldz" 并赋值给形参 (float类型) ' v ',并定义参数 (float类型) ' ctax '保存最后计算的个人所得税 
 Output: 无输出
